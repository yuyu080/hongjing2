...
def get_label_probability(iter_data):
    ...
    for each_row in iter_data:
        if (each_row['feature_25'] and each_row['feature_26'] and 
            ...
            data = [each_row['ex_feature_1'], each_row['ex_feature_2'], 
                    each_row['ex_feature_3'], each_row['ex_feature_4'],
    ...
    bst = xgb.Booster()
    bst.load_model("EX_28feats_release.model")
